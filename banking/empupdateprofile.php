...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <a href="apptoveatm.php">ATM Requests</a>
...
function updateProfile($empid)
{
  ...
  $db_name="banking"; 
    ...
    //taking input
    echo "<form method=post action=empupdateprofile2.php>";
    ...
    echo "<tr><td>Mobile Number</td><td>:</td><td><input type=text name=mobile value=".$row['mobile']."></td></tr>";
    echo "<tr><td>Email Id</td><td>:</td><td><input type=text name=email value=".$row['email']."></td></tr>";
    echo "<tr><td><input type=submit value=update></td><td></td><td><a href=emphome.php>HomePage</a></td></tr></table></form> ";
}
