...
function retreiveProfile($userid)
{
    //credentials
    $host="localhost"; 
    $username="root"; 
    ...
    echo "<table bgcolor='#006666' align=center border='1' bordercolor='#006666'><tr><td align=center colspan=3><strong><h2> USER Profile</h2></strong></td></tr>";
    echo "<tr><td >User ID</td><td>:</td><td >".$row['userid']."</td></tr>";
    echo "<tr><td>Mobile Number</td><td>:</td><td>".$row['mobilenumber']."</td></tr>";
