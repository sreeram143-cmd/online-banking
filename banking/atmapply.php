...
<br><br>
<form method="post" action="atmapply2.php">
<table bgcolor="#3d3d5c" align="center" border="0" cellspacing="0">
			<tr>
				<td>
			<table  width="100%" align="center" border="0" cellpadding="10">
				<tr>
					<td align="center" colspan="3"><strong><h2> ATM Request</h2></strong></td>
				</tr>
				<tr>
				...
				<tr>
                <tr>
					<td class = "select" id="cardtype"> Card Type </td>
					<td>:</td>
					<td>
                        <select name="type">
				...
				</tr><tr><td><a href=homepage.php>HomePage</a></td></tr></table>
			</table>
	</td>
</tr>
</table>
