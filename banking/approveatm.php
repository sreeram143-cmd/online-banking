...
$app="n";
//displaying requests
$sql="select * from atmrequests where approved='$app'";
$result=mysqli_query($con,$sql);
if ($result)
{
    while ($row=mysqli_fetch_array($result))
    {
        echo "<tr><td> ". $row['requestid']." </td><td> " . $row['name'] ." </td><td> " . $row['accountno'] ." </td>";
        echo "<td> " . $row['cardtype'] ." </td><td> " . $row['delivery'] ." </td><td> <input type=submit name=rid value=" . $row['requestid'] ."> </td></tr>"; 
    }
    echo "</table><form>";
